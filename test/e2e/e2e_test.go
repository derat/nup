...
func TestQueries(tt *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"maxRating=1", ignoreOrder, []db.Song{}},
		{"maxRating=2", ignoreOrder, []db.Song{}},
		{"maxRating=3", ignoreOrder, []db.Song{LegacySong2}},
		{"maxRating=4", ignoreOrder, []db.Song{LegacySong1, LegacySong2}},
		{"maxRating=5", ignoreOrder, []db.Song{s10s, LegacySong1, LegacySong2}},
